    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form = $this->_formFactory->create(['data' => ['html_id_prefix' => 'categoryicon_image_']]);
        ...
        $this->_eventManager->dispatch('adminhtml_categoryicon_edit_tab_image_prepare_form', ['form' => $form]);
    ...
    {
        return ['image' => 'Cmsmart\Categoryicon\Block\Adminhtml\Form\Element\Image'];
    }
}
