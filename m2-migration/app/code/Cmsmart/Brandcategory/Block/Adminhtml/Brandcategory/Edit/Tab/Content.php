...
/**
 * brandcategory edit form main tab
 */
    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var $model Cmsmart\BrandcategoryModel\Brandcategory */
        ...
        $form->setHtmlIdPrefix('brandcategory_content_');
        ...
        $this->_eventManager->dispatch('adminhtml_brandcategory_edit_tab_content_prepare_form', ['form' => $form]);
