...
class View extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $this->pageConfig->getTitle()->set($this->getBrandcategory()->getBrandName());
    }
    ...
    {
        return $this->_coreRegistry->registry('current_brandcategory');
    }
    ...
    {
        return $this->getUrl('brandcategory/index/index');
    }
