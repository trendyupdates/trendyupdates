define([
    ...
    'Cmsmart_Marketplace/js/advanced-pricing-handler',
    'Cmsmart_Marketplace/js/options/price-type-handler',
    'collapsible',
    ...
    return {
         ...
         */
        'Cmsmart_Marketplace/js/configurable-type-handler': function (data) {
