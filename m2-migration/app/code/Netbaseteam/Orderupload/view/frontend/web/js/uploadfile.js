            ...
            var options = {
                ...
                success: function (data, message, xhr) {
					...
					if(s.showComment) {
						...
						if( $('.ajax-file-upload-container .ajax-file-upload-statusbar .ajax-file-upload-comment').length <= 0){
							pd.done.insertBefore(".ajax-file-upload-container .ajax-file-upload-statusbar .ajax-file-upload-red");
						} 
						if( $('.ajax-file-upload-container .ajax-file-upload-statusbar .ajax-file-upload-comment').css('display') == 'none'){
							$('.ajax-file-upload-container .ajax-file-upload-statusbar .ajax-file-upload-comment').css('display', 'block');
						}
					}
