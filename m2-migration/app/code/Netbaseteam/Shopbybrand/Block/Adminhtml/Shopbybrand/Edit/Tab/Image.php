    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form = $this->_formFactory->create(['data' => ['html_id_prefix' => 'shopbybrand_image_']]);
        ...
        $this->_eventManager->dispatch('adminhtml_shopbybrand_edit_tab_image_prepare_form', ['form' => $form]);
    ...
    {
        return ['image' => 'Netbaseteam\Shopbybrand\Block\Adminhtml\Form\Element\Image'];
    }
}
