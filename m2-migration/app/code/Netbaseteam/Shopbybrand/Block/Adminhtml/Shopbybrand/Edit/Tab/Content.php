...
/**
 * shopbybrand edit form main tab
 */
    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var $model Netbaseteam\ShopbybrandModel\Shopbybrand */
        ...
        $form->setHtmlIdPrefix('shopbybrand_content_');
        ...
        $this->_eventManager->dispatch('adminhtml_shopbybrand_edit_tab_content_prepare_form', ['form' => $form]);
