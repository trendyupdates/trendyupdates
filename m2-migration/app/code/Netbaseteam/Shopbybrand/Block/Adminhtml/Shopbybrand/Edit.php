...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Netbaseteam_Shopbybrand::shopbybrand_delete')) {
    ...
    {
        if ($this->_coreRegistry->registry('shopbybrand')->getId()) {
            return __("Edit Shopbybrand '%1'", $this->escapeHtml($this->_coreRegistry->registry('shopbybrand')->getTitle()));
        } else {
