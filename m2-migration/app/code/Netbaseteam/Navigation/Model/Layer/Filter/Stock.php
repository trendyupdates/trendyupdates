...
{
    const IN_STOCK_COLLECTION_FLAG = 'cmsmart_stock_filter_applied';
    const CONFIG_FILTER_LABEL_PATH = 'cmsmart_navigation/stock_filter/label';
    const CONFIG_URL_PARAM_PATH    = 'cmsmart_navigation/stock_filter/url_param';
