<?php
namespace Netbaseteam\Navigation\Model\ResourceModel\Fulltext;
...
class Collection extends \Magento\Catalog\Model\ResourceModel\Product\Collection
{
	...
	public function getSearchCriteriaBuilder()
	{
		if ($this->searchCriteriaBuilder === null) {
			$this->searchCriteriaBuilder = ObjectManager::getInstance()
				->get('\Netbaseteam\Navigation\Model\Search\SearchCriteriaBuilder');
		}
	 ...
	 * @return void
	 */
	public function setSearchCriteriaBuilder(\Netbaseteam\Navigation\Model\Search\SearchCriteriaBuilder $object)
	{
