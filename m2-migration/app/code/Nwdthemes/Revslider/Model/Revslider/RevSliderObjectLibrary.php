...
class RevSliderObjectLibrary {
    ...
    public function _get_list($force = false){
        ...
        if(time() - $last_check > 1296000 || $force == true){ //30 days
            ...
            $request = $this->_framework->wp_remote_post($this->library_url.$this->library_list, array(
                'body' => $rattr
            ));
            ...
            if(!file_exists($file) || isset($temp['push_image'])){
                ...
                if($curl !== false){
                    ...
                    if($validated == 'false' && $type != 'thumb'){
                        ...
                        $image_data = $this->_framework->wp_remote_post($this->library_url.$this->library_download, array(
                            'body' => array(
                                'code' => urlencode($code),
