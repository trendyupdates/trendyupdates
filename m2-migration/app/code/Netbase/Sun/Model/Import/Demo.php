...
class Demo
{
    ...
    public function importDemo($demo_version,$store=NULL,$website = NULL)
    {
        ...
        try {
            ...
            $this->_objectManager->get('Netbase\Sun\Model\Cssconfig\Generator')->generateCss('design','','');
            $this->_objectManager->get('Netbase\Sun\Model\Cssconfig\Generator')->generateCss('settings','','');
