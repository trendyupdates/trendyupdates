...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Netbase_Product::product_delete')) {
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('product')->getId()) {
            return __("Edit Type '%1'", $this->escapeHtml($this->_coreRegistry->registry('product')->getTitle()));
        } else {
            return __('New Type');
        }
    }
    ...
    {
        return $this->getUrl('product/*/save', ['_current' => true, 'back' => 'edit', 'active_tab' => '{{tab_id}}']);
    }
