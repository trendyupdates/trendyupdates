...
return [
    'modules' => [
        ...
        'Magento_Directory' => 1,
        'Magento_Theme' => 1,
        'Cmsmart_Brandcategory' => 1,
        'Cmsmart_Categoryicon' => 1,
        'Cmsmart_Core' => 1,
        'Magento_Eav' => 1,
        'Cmsmart_Megamenu' => 0,
        'Cmsmart_Quickview' => 1,
        ...
        'Netbase_Product' => 1,
        'Netbase_Sun' => 1,
        'Netbaseteam_Ajaxcart' => 1,
        'Netbaseteam_Ajaxsearch' => 1,
        'Netbaseteam_Blog' => 1,
        'Netbaseteam_Faq' => 1,
        'Netbaseteam_Locator' => 1,
        'Netbaseteam_Navigation' => 1,
        'Netbaseteam_Opc' => 1,
        'Netbaseteam_Optimizesite' => 1,
        'Netbaseteam_Orderupload' => 1,
        'Netbaseteam_Shopbybrand' => 1,
        'Nwdthemes_Base' => 1,
