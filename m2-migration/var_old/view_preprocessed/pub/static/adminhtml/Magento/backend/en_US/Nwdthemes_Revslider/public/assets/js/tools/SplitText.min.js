...
return(typeof(document)==="undefined")?e:(document.querySelectorAll?document.querySelectorAll(e):document.getElementById((e.charAt(0)==="#")?e.substr(1):e));};SplitText.version="0.4.0";})(_gsScope);(function(name){"use strict";var getGlobal=function(){return(_gsScope.GreenSockGlobals||_gsScope)[name];};if(typeof(define)==="function"&&define.amd){define([],getGlobal);}else if(typeof(module)!=="undefined"&&module.exports){module.exports=getGlobal();}}("SplitText"));